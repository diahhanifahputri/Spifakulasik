    ...
    <nav id="mainNav" class="navbar navbar-default navbar-custom navbar-dark bg-dark navbar-fixed-top">
        <div class="container">
            ...
            <div class="navbar-header page-scroll">
                ...
                <a class="navbar-brand page-scroll" href="{{URL::to('/')}}"> SPIFAKULASIK </a>
            </div>
                    ...
                    <ul class="timeline">
                        <li>
                            <div class="timeline-image">
                                <img class="img-circle img-responsive" src="css/img/1.jpg" alt="" width="200" height="200">
                            </div>
                        ...
                        <li class="timeline-inverted">
                            <div class="timeline-image">
                                <img class="img-circle img-responsive" src="css/img/3.jpg" alt="" width="200" height="200">
                            </div>
                            <div class="timeline-panel">
                                <div class="timeline-heading">
                                    <h4>Keunggulan</h4>
            ...
            <div class="row">
                <div class="col-sm-6">
                    <div class="team-member">
                        <img src="css/img/team/aisy.jpg" class="img-responsive img-circle" alt="" width="200" height="200">
                        <h4>Aisyaturrodiyah</h4>
                        <p class="text-muted">17523237</p>
                        <ul class="list-inline social-buttons">
                            <li><a href="https://plus.google.com/u/0/107371548266757328220"><i><img src="css/img/email.png"></i></a>
                            </li>
                            <li><a href="https://www.instagram.com/aisyy14_"><i><img src="css/img/instagram.png"></i></a>
                            </li>
                ...
                <div class="col-sm-6">
                    <div class="team-member">
                        <img src="css/img/team/diah.jpg" class="img-responsive img-circle" alt="" width="200" height="200">
                        <h4>Diah Hanifah Putri</h4>
                        <p class="text-muted">17523106</p>
                        <ul class="list-inline social-buttons">
                            <li><a href="https://plus.google.com/u/1/106814714125072279078"><i><img src="css/img/email.png"></i></a>
                            </li>
                            <li><a href="https://www.instagram.com/diahhanifahputri"><i><img src="css/img/instagram.png"></i></a>
                            </li>
                            <li><a href="#"><i><img src="css/img/linkedin.png"></i></a>
                            </li>
                        </ul>
